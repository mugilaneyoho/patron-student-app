        ...
        <View style={styles.heroSection}>
          ...
          <View style={styles.batchTag}>
            <Text style={styles.batchTagText}>
              {dashboard?.batch?.batchName || 'Batch A'} • {dashboard?.student_id || 'Student'}
            </Text>
          </View>
        </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.infoRow}>
              ...
              <View style={styles.infoContent}>
                ...
                <Text style={styles.infoValue}>{dashboard.course.course_name}</Text>
              </View>
            </View>
          </View>
        )}
        ...
        <View style={styles.card}>
          ...
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoContent}>
              ...
              <Text style={[styles.infoValue, { color: '#94a3b8' }]}>{profile.email}</Text>
            </View>
          </View>
          ...
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoContent}>
              ...
              {isEditing ? (
                ...
                <Text style={styles.infoValue}>{profile.qualification || 'N/A'}</Text>
              )}
            </View>
          </View>
        </View>
